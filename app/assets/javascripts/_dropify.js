...
Dropify.App = function() {
  ...
  var paymentForm = new Dropify.PaymentForm("#stripe_form");
  var adForm = new Dropify.AdForm("#create_advert_title", "#create_advert_url", "#create_advert_content", "#create_advert_submit", "#create_advert_cancel", messageHandler, map, paymentForm)
  map.adForm = adForm;
